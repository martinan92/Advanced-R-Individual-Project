...
metrics_plot(fe_output_1[[3]], c('baseline','fe1'))
```
...
metrics_plot(fe_output_2[[3]], c('baseline','fe1','fe2'))
...
metrics_plot(fe_output_3[[3]], c('baseline','fe1','fe2','fe3'))
```
...
metrics_plot(fe_output_4[[3]], c('baseline','fe1','fe2','fe3','fe4'))
```
...
metrics_plot(fe_output_final[[3]], c('baseline','fe1','fe2','fe3','fe4','fe5','fe_final'), verbose = T)
```
...
metrics_plot(df_pipeline_pred, c('baseline','fe1','fe2','fe3','fe4','fe5','fe_final','final'), verbose = T)
```
...
#Takes too long, adds no value
# fit_control <- trainControl(method = "cv", number = 3, search = "random")
