...
split_and_train <- function(df, seed = 123456){
  ...
  fe_rf <- ranger(formula = as.formula(price~.), data=split_fe_train_df$train[,!c('id')],num.trees=400)
  print(fe_rf)
  
  fe<-predict(fe_rf, data = split_fe_train_df$test, type='response')$predictions
  df_pipeline_pred<-cbind(df_pipeline_pred, fe)
  
  return(list(split_fe_train_df, fe, df_pipeline_pred))
}
...
rmse_rf1<-rmse(real=fe_output_1[[1]]$test$price, predicted = fe_output_1[[2]])
mae_rf1<-mae(real=fe_output_1[[1]]$test$price, predicted = fe_output_1[[2]])
mape_rf1<-mape(real=fe_output_1[[1]]$test$price, predicted = fe_output_1[[2]])
...
rsq_fe1<-custom_rsq(real=fe_output_1[[1]]$test$price, predicted = fe_output_1[[2]])
rsq_fe1
...
rmse_rf2<-rmse(real=fe_output_2[[1]]$test$price, predicted = fe_output_2[[2]])
mae_rf2<-mae(real=fe_output_2[[1]]$test$price, predicted = fe_output_2[[2]])
mape_rf2<-mape(real=fe_output_2[[1]]$test$price, predicted = fe_output_2[[2]])
...
rsq_fe2<-custom_rsq(real=fe_output_2[[1]]$test$price, predicted = fe_output_2[[2]])
rsq_fe2
...
rmse_rf2<-rmse(real=fe_output_3[[1]]$test$price, predicted = fe_output_3[[2]])
mae_rf2<-mae(real=fe_output_3[[1]]$test$price, predicted = fe_output_3[[2]])
mape_rf2<-mape(real=fe_output_3[[1]]$test$price, predicted = fe_output_3[[2]])
...
rsq_fe3<-custom_rsq(real=fe_output_3[[1]]$test$price, predicted = fe_output_3[[2]])
rsq_fe3
